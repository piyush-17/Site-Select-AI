...
export const DollarSignIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 11.21 12.75 11.5 12 11.5c-.75 0-1.536-.29-2.121-.868-1.172-.879-1.172-2.303 0-3.182C10.464 6.29 11.25 6 12 6c.75 0 1.536.29 2.121.868l.879.659m0 0c-1.171.879-3.07.879-4.242 0-1.172-.879-1.172-2.303 0-3.182s2.303-.879 3.182 0c.879.879.879 2.303 0 3.182z" />
    </svg>
);
